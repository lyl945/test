...
public class SecuritiesActivity extends CommonActivity implements
	...
	private void updateDisplay() {
		...
		myHttpUtils.getHttpJsonString(params, Constans.ashRecord, handler,
		...
		public View getView(int position, View convertView, ViewGroup arg2) {
			...
			holder.find.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					params.addQueryStringParameter("fromDate", defaultStartDate);
					params.addQueryStringParameter("toDate", defaultEndDate);
					myHttpUtils.getHttpJsonString(params, Constans.ashRecord,
	...
	class ViewHolder {
		TextView time, jifen, beizhu, find;
	...
	android.view.View.OnClickListener {
		...
		public void onClick(View v) {
			...
			msg.what = SecuritiesActivity.SHOW_DATAPICK;
			// }
			// if (timeEnd.equals((Button) v)) {
			// msg.what = Text123456Activity.SHOW_DATAPICK2;
			// }
			SecuritiesActivity.this.saleHandler.sendMessage(msg);
		}
	}
	...
	android.view.View.OnClickListener {
		...
		public void onClick(View v) {
			...
			// }
			// if (timeEnd.equals((Button) v)) {
			msg.what = SecuritiesActivity.SHOW_DATAPICK2;
			// }
			SecuritiesActivity.this.saleHandler.sendMessage(msg);
		}
	}
	...
	Handler saleHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			// 时间选择1的按钮时间
			case SecuritiesActivity.SHOW_DATAPICK:
				showDialog(DATE_DIALOG_ID);
				break;
			// 时间选择2的按钮时间
			case SecuritiesActivity.SHOW_DATAPICK2:
