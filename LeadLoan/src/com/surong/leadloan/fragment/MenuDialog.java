...
public class MenuDialog extends Dialog{
	...
	private void init() {
		...
		int m=getContext().getResources().getDimensionPixelOffset(R.dimen.dimen_16);
		int w=getContext().getResources().getDisplayMetrics().widthPixels-m*2;
	...
	public void addItem(String text,int id,Object tag) {
		...
		if (body.getChildCount()>2) {
			//��֮ǰ����һ����Ϊ��ͨ��,�ǵ�Ҫ������������
			body.getChildAt(body.getChildCount()-2).setBackgroundResource(R.drawable.clickable_mid_selector);
		}
		//����ǵ�һ��
		...
		LayoutParams params=new LayoutParams(LayoutParams.FILL_PARENT, (int)getContext().getResources().getDimension(R.dimen.plain_text_h));
