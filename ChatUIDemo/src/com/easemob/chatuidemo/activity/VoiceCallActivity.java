...
import com.easemob.chatuidemo.imageutils.ImageFetcher;
...
//        bundle = getIntent().getExtras();
        ...
        mImageFetcher = ImageFetcher.Instance(this, 0);
        ...
        DataWrapper userInfoWrapper = databaseUserInfo.getUserInfoByUserID(username);
        String displayName = StringUtility.select(
        ...
        userInfoWrapper
                ...
                username);
        if (null != displayName) {
            nickTextView.setText(displayName);
        }
        
        String headimage = userInfoWrapper
                .getString(EASEDatabaseUserInfo.UserImg);
        
        if (null != headimage) {
            mImageFetcher.addTask(headImage, headimage, 0);
            headImage.setTag(headimage);
        }
